...
async def help(ctx):
    authortoken = str(ctx.author.id)
    embed = pyd.res.discord.Embed(title="Head over to my website to see a full list of my commands!", description="https://azerbot.netlify.app/commands") #,color=Hex code
